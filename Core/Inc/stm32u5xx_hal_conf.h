...
#define  USE_HAL_SAES_REGISTER_CALLBACKS       0U /* SAES register callback disabled      */
...
#endif /* HAL_LPGPIO_MODULE_ENABLED */
...
#ifdef HAL_SAES_MODULE_ENABLED
 #include "stm32u5xx_hal_saes.h"
#endif /* HAL_SAES_MODULE_ENABLED */
